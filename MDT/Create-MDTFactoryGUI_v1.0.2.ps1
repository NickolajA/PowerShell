function Load-Form {
    ...
    $MainTabControl.Controls.AddRange(@(
        $TabPageSetup, 
        $TabPageMDT, 
        $TabPageWSUS, 
        $TabPageApplications, 
	...
	$TabPageSetup.Controls.AddRange(@(
        $CMBGeneralOptionModeOS, 
        $CMBGeneralOptionMode, 
        $CBGeneralInternet,
        $LabelGeneralOption, 
        $LabelGeneralSF, 
        $TBSFMDT, 
    ...
    $TabPageMDT.Controls.AddRange(@(
        $LabelMDTUP, 
        $LabelMDTDSPath, 
        $LabelMDTDSName, 
        $LabelMDTBIFeatures, 
        $LabelMDTBIScratchSpace, 
        $TBMDTDSPath, 
        $TBMDTDSName, 
        $TBMDTUserName, 
        $TBMDTPassword, 
    ...
    $TabPageWSUS.Controls.AddRange(@(
        $CBWSUSCriticalUpdates,
        $CBWSUSSecurityUpdates, 
        $CBWSUSUpdates, 
        $CBWSUSDefinitionUpdates, 
        $TBWSUSContentFolder, 
        $LabelWSUSProducts, 
        $LabelWSUSLanguages, 
        $LabelWSUSContentFolder, 
        $LabelWSUSUpdateClassification, 
        $ButtonWSUSProducts, 
        $ButtonWSUSProductsRemove, 
        $ButtonWSUSLanguages, 
        $ButtonWSUSLanguagesRemove, 
        $CMBWSUSLanguageSelection, 
        $CMBWSUSProductSelection, 
        $DGVWSUSProducts, 
        $DGVWSUSLanguages, 
        $GBWSUSProducts, 
        $GBWSUSLanguages, 
        $GBWSUSContentFolder, 
        $GBWSUSUpdateClassification
    ))
    $TabPageApplications.Controls.AddRange(@(
        $ButtonAppBrowse, 
        $LabelApp, 
        $TBAppPath, 
        $DGVApp, 
...
function Remove-WSUSProduct {
    param(
    [parameter(Mandatory=$true)]
    $RowIndex
    )
    if ($DGVWSUSProducts.RowCount -ge 1) {
        $DGVWSUSProducts.Rows.RemoveAt($RowIndex)
    }
}
...
function Remove-WSUSLanguage {
    param(
    [parameter(Mandatory=$true)]
    $RowIndex
    )
    if ($DGVWSUSLanguages.RowCount -ge 1) {
        $DGVWSUSLanguages.Rows.RemoveAt($RowIndex)
    }
}
...
function Validate-OSPath {
    ...
    if ($OSPath.Length -gt 255) {
        Write-OutputBox -OutputBoxMessage "SourcePath is longer than 255 characters for '$($OSName), skipping import'" -Type WARNING
        return $false
    }
    elseif (-not(Test-Path -Path $OSPath -ErrorAction SilentlyContinue)) {
...
function Validate-AppPath {
    ...
    if ($AppPath.Length -gt 255) {
        Write-OutputBox -OutputBoxMessage "SourcePath is longer than 255 characters for '$($AppName), skipping import'" -Type WARNING
        return $false
    }
    elseif (-not(Test-Path -Path $AppPath -ErrorAction SilentlyContinue)) {
...
function Start-Installation {
    ...
    try {
        ...
        [System.Windows.Forms.Application]::DoEvents()
        $WarningPromptWindow = Show-MessageBox -Message "A warning occurred during installation. Please review the log information.`nPress OK to continue or Cancel to stop the installation and exit the tool." -WindowTitle "Warning" -Buttons OKCancel -Icon Warning
        switch ($WarningPromptWindow) {
            "OK" { 
                return
            }
            "Cancel" {
    ...
    # Run these phases only if there's an active internet connection
    if ($CBGeneralInternet.Checked -eq $true) {
        ...
        Write-OutputBox -OutputBoxMessage "WSUS configuration was skipped due to no internet availability" -Type INFO
    }
    ...
    if ($CBGeneralInternet.Checked -eq $true) {
        ...
        Write-OutputBox -OutputBoxMessage "ADK installation was skipped due to no internet availability" -Type INFO
    }
    ...
    if ($CBGeneralInternet.Checked -eq $false) {
        Write-OutputBox -OutputBoxMessage "WSUS configuration was skipped due to no internet availability. Manual configuration is required" -Type INFO
    }
    Interactive-TabPages -Option Enable
    $ButtonStart.Enabled = $true
}
...
$Form.Text = "MDT Factory Tool 1.0.2"
...
$CMBGeneralOptionMode.Location = New-Object System.Drawing.Size(30,240)
...
$CMBGeneralOptionModeOS.Location = New-Object System.Drawing.Size(200,240)
...
# CheckBoxes
$CBGeneralInternet = New-Object System.Windows.Forms.CheckBox
$CBGeneralInternet.Location = New-Object System.Drawing.Size(20,310)
$CBGeneralInternet.Size = New-Object System.Drawing.Size(260,20)
$CBGeneralInternet.Text = "Internet availability is present on this system"
$CBGeneralInternet.Checked = $true
...
$LabelGeneralSF.Size = New-Object System.Drawing.Size(460,20)
$LabelGeneralSF.Text = "Browse for Microsoft Deployment Toolkit and Windows Assessment Deployment Kit files:"
$LabelGeneralOption = New-Object System.Windows.Forms.Label
$LabelGeneralOption.Location = New-Object System.Drawing.Size(18,200)
...
$ButtonSFMDTBrowse.Location = New-Object System.Drawing.Size(410,70) 
...
$ButtonSFADKBrowse.Location = New-Object System.Drawing.Size(410,130) 
...
$ButtonWSUSProductsRemove = New-Object System.Windows.Forms.Button
$ButtonWSUSProductsRemove.Location = New-Object System.Drawing.Size(81,225) 
$ButtonWSUSProductsRemove.Size = New-Object System.Drawing.Size(80,20) 
$ButtonWSUSProductsRemove.Text = "Remove"
$ButtonWSUSProductsRemove.Add_MouseClick({
    if ($DGVWSUSProducts.SelectedCells[0].RowIndex -ne $null) {
        Remove-WSUSProduct -RowIndex $DGVWSUSProducts.SelectedCells[0].RowIndex
    }
})
...
$ButtonWSUSLanguagesRemove = New-Object System.Windows.Forms.Button
$ButtonWSUSLanguagesRemove.Location = New-Object System.Drawing.Size(336,225) 
$ButtonWSUSLanguagesRemove.Size = New-Object System.Drawing.Size(80,20) 
$ButtonWSUSLanguagesRemove.Text = "Remove"
$ButtonWSUSLanguagesRemove.Add_MouseClick({
    if ($DGVWSUSLanguages.SelectedCells[0].RowIndex -ne $null) {
        Remove-WSUSLanguage -RowIndex $DGVWSUSLanguages.SelectedCells[0].RowIndex
    }
})
...
$GBGeneralSF.Size = New-Object System.Drawing.Size(500,160) 
$GBGeneralSF.Text = "Setup files"
$GBGeneralSF.BackColor = "White"
$GBGeneralOption = New-Object System.Windows.Forms.GroupBox
$GBGeneralOption.Location = New-Object System.Drawing.Size(10,175) 
...
$GBGeneralInternet = New-Object System.Windows.Forms.GroupBox
$GBGeneralInternet.Location = New-Object System.Drawing.Size(10,290) 
$GBGeneralInternet.Size = New-Object System.Drawing.Size(500,50) 
$GBGeneralInternet.Text = "Internet Availability"
$GBGeneralInternet.BackColor = "White"
$GBGeneralOptionMode = New-Object System.Windows.Forms.GroupBox
$GBGeneralOptionMode.Location = New-Object System.Drawing.Size(20,220) 
...
$GBGeneralOptionOS.Location = New-Object System.Drawing.Size(190,220) 
...
$GBSFMDT.Location = New-Object System.Drawing.Size(20,50) 
...
$GBSFADK.Location = New-Object System.Drawing.Size(20,110) 
