<#
.SYNOPSIS
    Distribute driver packages in ConfigMgr 2012 that have not been added to a Distribution Point Group
.DESCRIPTION
    Distribute driver packages in ConfigMgr 2012 that have not been added to a Distribution Point Group
.PARAMETER SiteServer
    Site server name with SMS Provider installed
.PARAMETER DPGroupName
    Name of a Distribution Point Group where all non-distributed driver packages will be added to
.EXAMPLE
    Distribute all driver packages that have not yet been distributed to a Distribution Point Group called 'All DPs', on a Primary Site server called 'CM01':
    .\Start-CMDriverPackageDistribution.ps1 -SiteServer CM01 -DPGroupName "All DPs"
.NOTES
    Script name: Start-CMDriverPackageDistribution.ps1
