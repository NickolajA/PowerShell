...
function Interactive-SiteRolesControlVisibility {
    ...
    Begin {
        ...
        $ControlsArrayList.AddRange(@("Option Enrollment Point","Option Management Point","Option Distribution Point","Option Application Catalog","Option Site System Roles","Option Configuration Files"))
        switch ($Mode) {
...
function Interactive-OtherControlVisibility {
    ...
    $Mode,
    [parameter(Mandatory=$true)]
    [ValidateSet("EAD","WSUS","ADK","SMC","Files")]
    $Module
    )
    Begin {
        $OtherControlsArrayList = New-Object System.Collections.ArrayList
        $OtherControlsArrayList.AddRange(@("Option Extend Active Directory","Option Install WSUS","Option Install Windows ADK","Option System Management Container","Option Make a selection","Option Configuration Files"))
        switch ($Mode) {
...
$Form.Text = "ConfigMgr 2012 R2 Prerequisites Installation Tool - 1.3.1"
...
$ButtonInstallSiteRoles.Add_Click({
    ...
    elseif ($RadioButtonSiteRoleEP.Checked -eq $true) {
        if (($ComboBoxSiteRolesEP.Text -eq "Enrollment Point") -or ($ComboBoxSiteRolesEP.Text -eq "Enrollment Proxy Point")) {
            Write-OutputBox -OutputBoxMessage "Begin installing prerequisites for an $($ComboBoxSiteRolesEP.Text) role" -Type "INFO: " -Object SiteRoles
            Install-EP
        }
        else {
...
$ButtonInstallOther.Add_Click({
    if (($RadioButtonOtherEAD.Checked -eq $true) -or ($RadioButtonOtherWSUS.Checked -eq $true) -or ($RadioButtonOtherADK.Checked -eq $true) -or ($RadioButtonOtherSMC.Checked -eq $true) -or ($RadioButtonOtherFiles.Checked -eq $true)) {
        ...
        if ($RadioButtonOtherFiles.Checked -eq $true) {
            #Search-SMC
        }
    }
    else {
...
$RadioButtonOtherEAD.Add_MouseClick({
    ...
    if ($OutputBoxOther.Size.Width -eq 300) {
        $OutputBoxOther.Size = New-Object System.Drawing.Size(553,350)
    }
    ...
    Interactive-OtherControlVisibility -Mode Disable -Module Files
...
###
$RadioButtonOtherFiles = New-Object System.Windows.Forms.RadioButton
$RadioButtonOtherFiles.Location = New-Object System.Drawing.Size(25,155)
$RadioButtonOtherFiles.Size = New-Object System.Drawing.Size(181,25)
$RadioButtonOtherFiles.Text = "Configuration Files"
$RadioButtonOtherFiles.Name = "Option Configuration Files"
$RadioButtonOtherFiles.Font = New-Object System.Drawing.Font("Microsoft Sans Serif","8.25",[System.Drawing.FontStyle]::Regular)
$RadioButtonOtherFiles.Checked = $false
$RadioButtonOtherFiles.Add_Click({
    if ($RadioButtonOtherFiles.Checked -eq $true) {
        $OutputBoxOther.ResetText()
    }
    $ProgressBarOther.Value = 0
    ...
    if ($OutputBoxOther.Size.Width -eq 553) {
        $OutputBoxOther.Size = New-Object System.Drawing.Size(300,350)
    }
    Write-OutputBox -OutputBoxMessage "Configuration Files selections loaded" -Type "INFO: " -Object Other
    Write-OutputBox -OutputBoxMessage "Add this text later" -Type "INFO: " -Object Other
    Interactive-OtherControlVisibility -Mode Disable -Module EAD
    Interactive-OtherControlVisibility -Mode Disable -Module ADK
    Interactive-OtherControlVisibility -Mode Disable -Module WSUS
    Interactive-OtherControlVisibility -Mode Disable -Module SMC
    $TabPageOther.Controls.Add($CBFilesSMS)
    Interactive-OtherControlVisibility -Mode Enable -Module Files
})
###
...
$CBFilesSMS = New-Object System.Windows.Forms.CheckBox
$CBFilesSMS.Location = New-Object System.Drawing.Size(10,425)
$CBFilesSMS.Size = New-Object System.Drawing.Size(170,20)
$CBFilesSMS.Text = "NO_SMS_ON_DRIVE.SMS"
$CBFilesSMS.Name = "Files"
